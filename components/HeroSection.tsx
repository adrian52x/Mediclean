        ...
        <section>
            <div className="w-full grid lg:grid-cols-2 lg:items-center gap-10">
                ...
                <div className="relative hidden lg:block pt-5 flex h-[32rem] sm:w-full">
                    ...
                    <Image src={images[0].url} alt="dezinfect_img1" width={600} height={600} sizes="(min-width: 1024px) 25vw, 0px" quality={65} priority className="w-full h-full object-cover z-30" />
                    </div>
                    ...
                    <Image src={images[4].url} alt="dezinfect_img2" height={600} width={600} sizes="(min-width: 1024px) 25vw, 0px" quality={65} priority className="z-10 w-full h-full object-cover" />
                    </div>
                    ...
                    <Image src={images[1].url} alt="dezinfect_img3" height={600} width={600} sizes="(min-width: 1024px) 25vw, 0px" quality={65} priority className="z-10 w-full h-full object-cover" />
                    </div>
                </div>
            </div>
        </section>
